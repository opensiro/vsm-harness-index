...
ASSESSMENTS = {
    "abhed": (ROOT / "assessments" / "abhed.md", "151b8ddceee7ae232e526b3c237356151dde780e"),
    "haorui-agent-harness": (
        ROOT / "assessments" / "haorui-agent-harness.md",
        "109dde248cb44227a9ed3a204790432a6da843da",
    ),
    "taixu": (ROOT / "assessments" / "taixu.md", "037880a898ad503128dee7b2991dd6d351ad8cb3"),
    "caelis": (ROOT / "assessments" / "caelis.md", "5aebbc6a750b8b2d472a0987fbf2e0942062c6d9"),
}

FUNCTIONS = {
    "S2": {
        "assessment_key": "autonomy_s2",
        "states": {"abhed": "A", "taixu": "A", "caelis": "A"},
        "delta": EXP / "s2-system-benchmarks" / "post-closure-deltas" / "abhed-taixu-caelis-2026-09-26.json",
    ...
    "S3": {
        ...
        "states": {"haorui-agent-harness": "A", "taixu": "A", "caelis": "A"},
        "delta": EXP / "s3-system-benchmarks" / "post-closure-deltas" / "agent-harness-taixu-caelis-2026-09-26.json",
    ...
    "S3*": {
        ...
        "states": {"abhed": "A", "taixu": "C", "caelis": "C"},
        "delta": EXP / "s3star-system-benchmarks" / "post-closure-deltas" / "abhed-taixu-caelis-2026-09-26.json",
    ...
    "S4": {
        ...
        "states": {"taixu": "P"},
        "delta": EXP / "s4-system-benchmarks" / "post-closure-deltas" / "taixu-2026-09-26.json",
...
class PostAdmissionCapabilityDelta683Test(unittest.TestCase):
    def test_negative_public_evidence_deltas_are_fail_closed(self):
        assessment_fields = {}
        ...
        for function, cfg in FUNCTIONS.items():
            with self.subTest(function=function):
                ...
                self.assertEqual(delta.get("tracking_issue"), 683)
