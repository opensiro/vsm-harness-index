...
| S2 | `gap` | — | — | [`coverage.json`](s2-system-benchmarks/coverage.json) · reviewed `2026-09-25` · 20 reviewed cases · direct families: `7` · direct observations: `4` · canonical direct observations: `1` |
