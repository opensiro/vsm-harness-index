...
| S2 | `gap` | — | — | [`coverage.json`](s2-system-benchmarks/coverage.json) · reviewed `2026-09-25` · 22 reviewed cases · direct families: `8` · direct observations: `5` · canonical direct observations: `1` |
