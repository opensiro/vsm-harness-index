...
| S2 | `gap` | `direct_benchmark_families`: `7` · `direct_observations`: `4` · `canonical_direct_observations`: `1` · `native_proxy_projections`: `2` · `representative_canonical_s2_systems_inspected`: `15` | `2026-09-25` | [`s2-primary-search-closure.json`](s2-system-benchmarks/matched-cell/s2-primary-search-closure.json) |
