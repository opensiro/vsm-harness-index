# Pi — Batch 02 result record

Frozen candidate: `earendil-works/pi@71dca871bc80b6bc97be37f0ca3189399d651fff`
...
No run started, so the Batch 02 result-assurance states (`verified-success`, `verification-failed`, `verification-not-observed`, `unclear`) were **not coded**. Assigning one would incorrectly convert an infrastructure precondition failure into a property of Pi.
