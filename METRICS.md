...
| --- | ---: | --- |
| Included standalone assessments | 253 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 271 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 271 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 253) |
| 250 | Achieved | Achieved (current corpus: 253) |
| 500 | Next | 253/500 (50.6%) |
| 1000 | Planned | 253/1000 (25.3%) |
