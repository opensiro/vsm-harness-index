...
| Canonical assessment records | 247 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 247 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
