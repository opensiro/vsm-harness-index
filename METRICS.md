...
| --- | ---: | --- |
| Included standalone assessments | 260 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 278 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 278 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 260) |
| 250 | Achieved | Achieved (current corpus: 260) |
| 500 | Next | 260/500 (52.0%) |
| 1000 | Planned | 260/1000 (26.0%) |
