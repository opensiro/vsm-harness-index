...
| --- | ---: | --- |
| Included standalone assessments | 256 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 274 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 274 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 256) |
| 250 | Achieved | Achieved (current corpus: 256) |
| 500 | Next | 256/500 (51.2%) |
| 1000 | Planned | 256/1000 (25.6%) |
