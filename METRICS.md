...
| --- | ---: | --- |
| Included standalone assessments | 157 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 158 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 158 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 157) |
| 250 | Next | 157/250 (62.8%) |
| 500 | Planned | 157/500 (31.4%) |
| 1000 | Planned | 157/1000 (15.7%) |
