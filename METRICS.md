...
| --- | ---: | --- |
| Included standalone assessments | 254 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 272 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 272 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 254) |
| 250 | Achieved | Achieved (current corpus: 254) |
| 500 | Next | 254/500 (50.8%) |
| 1000 | Planned | 254/1000 (25.4%) |
