...
| --- | ---: | --- |
| Included standalone assessments | 190 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 198 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 198 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 190) |
| 250 | Next | 190/250 (76.0%) |
| 500 | Planned | 190/500 (38.0%) |
| 1000 | Planned | 190/1000 (19.0%) |
