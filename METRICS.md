...
| --- | ---: | --- |
| Included standalone assessments | 258 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 276 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 276 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 258) |
| 250 | Achieved | Achieved (current corpus: 258) |
| 500 | Next | 258/500 (51.6%) |
| 1000 | Planned | 258/1000 (25.8%) |
