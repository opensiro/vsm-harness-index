...
| --- | ---: | --- |
| Included standalone assessments | 261 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 279 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 279 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 261) |
| 250 | Achieved | Achieved (current corpus: 261) |
| 500 | Next | 261/500 (52.2%) |
| 1000 | Planned | 261/1000 (26.1%) |
