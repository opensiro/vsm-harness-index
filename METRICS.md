...
| --- | ---: | --- |
| Included standalone assessments | 255 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 273 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 273 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 255) |
| 250 | Achieved | Achieved (current corpus: 255) |
| 500 | Next | 255/500 (51.0%) |
| 1000 | Planned | 255/1000 (25.5%) |
