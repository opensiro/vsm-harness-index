...
| --- | ---: | --- |
| Included standalone assessments | 257 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 275 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 275 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 257) |
| 250 | Achieved | Achieved (current corpus: 257) |
| 500 | Next | 257/500 (51.4%) |
| 1000 | Planned | 257/1000 (25.7%) |
