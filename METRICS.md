...
| --- | ---: | --- |
| Included standalone assessments | 259 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 277 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 277 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 259) |
| 250 | Achieved | Achieved (current corpus: 259) |
| 500 | Next | 259/500 (51.8%) |
| 1000 | Planned | 259/1000 (25.9%) |
