...
| --- | ---: | --- |
| Included standalone assessments | 131 | Canonical assessments with `status: included`; this is the public corpus-size milestone counter. |
| Canonical assessment records | 132 | Included plus canonical `excluded-no-agentic-vsm` assessment records. |
...
| Catalog entries | 132 | Rows in `data/catalog.psv`; this is discovery/order/provenance infrastructure, not a second assessment database. |
...
| ---: | --- | ---: |
| 100 | Achieved | Achieved (current corpus: 131) |
| 250 | Next | 131/250 (52.4%) |
| 500 | Planned | 131/500 (26.2%) |
| 1000 | Planned | 131/1000 (13.1%) |
